...
- Дай такой финальный ответ, чтобы пользователь получил всю нужную информацию без необходимости читать reasoning.
- Для задач, где требуется план, инструкция, разбор, объяснение, пример или творческий текст — оформи ответ подробно: структурированный список, таблица, пошаговая инструкция, пример кода или связный текст.
- Для задач, где нужен только итог, число или факт — дай краткий, но информативный ответ.
- Если требуется код — обязательно приведи пример кода с пояснением.
- Финальный ответ должен быть самодостаточным и понятным без reasoning.
- Не повторяй reasoning, но используй его выводы и логику рассуждений.
`,
  },
  en: {
